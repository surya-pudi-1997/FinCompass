...
export class AccountsController {
  ...
  async getAccount(req: Request, res: Response) {
    try {
      const account = await accountsService.findOne(req.params.id, req.user.userId);
      if (!account) {
  ...
  async createAccount(req: Request, res: Response) {
    ...
    try {
      ...
      const account = await accountsService.create(req.user.userId, accountData);
  ...
  async updateAccount(req: Request, res: Response) {
    ...
    try {
      ...
      const account = await accountsService.update(req.params.id, req.user.userId, accountData);
      res.json(account);
    } catch (error) {
